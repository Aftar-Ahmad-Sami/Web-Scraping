...
class GramerkagojSpider(CrawlSpider):
    name = "gramerkagoj"
    allowed_domains = ["gramerkagoj.com"]
    start_urls = ["https://gramerkagoj.com"]
    ...
    def __init__(self, *args, **kwargs):
        super(GramerkagojSpider, self).__init__(*args, **kwargs)
        self.db_connection = sqlite3.connect('db/seen_urls-gramerkagoj.db')
    ...
    def close(self, reason):
        ...
        with open('output/links-gramerkagoj.json', 'w') as f:
